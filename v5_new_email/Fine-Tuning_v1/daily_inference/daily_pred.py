...
def main(args, df, snapshot_map, gcid_map, thread_map, time_map, device):
    ...
    model_name=os.path.join(args.root_dir, args.test_date, args.output_dir)
...
if __name__=="__main__":
    ...
    parser.add_argument('--root_dir', type=str, default="/opt/omniai/work/instance1/jupyter/v5_new_email/Fine-Tuning/results")
