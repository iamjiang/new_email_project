import sys
sys.path.append('/opt/omniai/work/instance1/jupyter/v5_new_email/Fine-Tuning_v1/')
...
if __name__=="__main__":
    ...
    argparser.add_argument("--val_min_recall", type=float, default=0.98)
    ...
    best_threshold=utils.find_optimal_threshold(df['target'].values.squeeze(), df["Predicted_prob"].values.squeeze(), \
